...
class Blockchain:
    ...
    def add_transactions(self, sender, reciever, amount):
        self.transactions = {'sender': sender,
                             'reciever': reciever,
                             'amount': amount
                             }
...
def mine_block():
        ...
        blockcahin.add_transaction(sender = node_address, reciever = 'sahil', amount = 1)
        block = blockchain.create_block(proof, previous_hash)
        response = {'message': 'congrates!!',
                    'index': block['index'],
...
@app.route('/if_valid', methods =['GET'] )
def if_valid():
...
def connect_node():
    ...
    response = {'message': 'the nodes connected in blockcahin are following:',
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        response = {'message': 'this is the longest chain',
                    'actual _chain': blockchain.chain}
    return jsonify(response), 200
